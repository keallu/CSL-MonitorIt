    ...
    class GameMemoryPanel : UIPanel
    {
        ...
        public override void OnDestroy()
        {
            ...
            try
            {
                ...
                {
                    Destroy(_totalUsedNonPagedPoolText.gameObject);
                }
                if (_totalUsedPagedPoolText != null)
                {
                    Destroy(_totalUsedPagedPoolText.gameObject);
                }
                if (_totalUsedVirtualText != null)
                {
                    Destroy(_totalUsedVirtualText.gameObject);
                }
                if (_totalUsedPhysicalText != null)
                {
                    Destroy(_totalUsedPhysicalText.gameObject);
                }
                if (_totalUsedNonPagedPoolValue != null)
                {
                    Destroy(_totalUsedNonPagedPoolValue.gameObject);
                }
                if (_totalUsedPagedPoolValue != null)
                {
                    Destroy(_totalUsedPagedPoolValue.gameObject);
                }
                if (_totalUsedVirtualValue != null)
                {
                    Destroy(_totalUsedVirtualValue.gameObject);
                }
                if (_totalUsedPhysicalValue != null)
                {
                    Destroy(_totalUsedPhysicalValue.gameObject);
                }
                if (_totalUsedNonPagedPoolDesc != null)
                {
                    Destroy(_totalUsedNonPagedPoolDesc.gameObject);
                }
                if (_totalUsedPagedPoolDesc != null)
                {
                    Destroy(_totalUsedPagedPoolDesc.gameObject);
                }
                if (_totalUsedVirtualDesc != null)
                {
                    Destroy(_totalUsedVirtualDesc.gameObject);
                }
                if (_totalUsedPhysicalDesc != null)
                {
                    Destroy(_totalUsedPhysicalDesc.gameObject);
                }
            }
            catch (Exception e)
            {
        ...
        private void CreateUI()
        {
            try
            {
                ...
                _totalUsedPhysicalDesc.textScale = 0.7f;
                ...
                _totalUsedVirtualDesc.textScale = 0.7f;
                ...
                _totalUsedPagedPoolDesc.textScale = 0.7f;
                ...
                _totalUsedNonPagedPoolDesc.textScale = 0.7f;
                ...
                _totalUsedPhysicalValue.textScale = 0.7f;
                ...
                _totalUsedVirtualValue.textScale = 0.7f;
                ...
                _totalUsedPagedPoolValue.textScale = 0.7f;
                ...
                _totalUsedNonPagedPoolValue.textScale = 0.7f;
                ...
                _totalUsedPhysicalText.textScale = 0.7f;
                ...
                _totalUsedVirtualText.textScale = 0.7f;
                ...
                _totalUsedPagedPoolText.textScale = 0.7f;
                ...
                _totalUsedNonPagedPoolText.textScale = 0.7f;
        ...
        private void RefreshData()
        {
            try
            {
                SysInfo.GetMemory(out ulong totalUsedPhysical, out ulong totalUsedVirtual, out ulong totalUsedPagedPool, out ulong totalUsedNonPagedPool);
